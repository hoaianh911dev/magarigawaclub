...
export default {
    ...
    setup() {
        ...
        const { data: lstCompleted, isLoading } = useQuery([EQueryKey.TripCompleted, userId], () => getListBookingByStatus({status: EStatusBooking.Completed, userid: userId, typeBook: ETypeBooking.Trip}))
